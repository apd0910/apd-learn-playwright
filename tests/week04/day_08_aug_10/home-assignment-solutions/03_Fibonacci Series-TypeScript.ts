...
function fibonacciSequence(num: number): number[] {
    ...
    let prev : number= 0; // F(0)
    let curr : number = 1; // F(1)
...
// function’s functionality
try {
    console.log(`Fibinocci Sequence for 0 : ${fibonacciSequence(0)}`)
    console.log(`Fibinocci Sequence for 1 : ${fibonacciSequence(1)}`)
    console.log(`Fibinocci Sequence for 2 : ${fibonacciSequence(2)}`)
    console.log(`Fibinocci Sequence for 10 : ${fibonacciSequence(10)}`)
    console.log(`Fibinocci Sequence for -10 : ${fibonacciSequence(-10)}`)
    
} catch (error) {
    console.log(`Error Occcured : ${(error as Error).message}`)
}